 ...
 */
final class Version20231204172142 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE author (id INT NOT NULL, lastname VARCHAR(55) NOT NULL, firstname VARCHAR(55) NOT NULL, fathername VARCHAR(55) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE book (id INT NOT NULL, title VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, date DATE NOT NULL, PRIMARY KEY(id))');
